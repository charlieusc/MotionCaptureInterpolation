...
public: 
  ...
  void Interpolate(Motion * pInputMotion, Motion ** pOutputMotion, int N);
    //calculate a1, b2 for benzier Quaternion
    void calculateBQAnBn(Quaternion<double> &q0, Quaternion<double> &q1, Quaternion<double> &q2, Quaternion<double> &q3, Quaternion<double> &an, Quaternion<double> &bn, bool fq0, bool fq3);
